...
public class GuiCompressor extends GuiContainer {
	...
	private static final ResourceLocation guiTexture = new ResourceLocation("nucraftpower" , "textures/gui/container/compressor.png");
	private TileEntityCompressor tileEntity;
	
	final int FLAME_XPOS = 39;
	final int FLAME_YPOS = 52;
	final int FLAME_UVX = 176;
	final int FLAME_UVY = 0;
	final int FLAME_HEIGHT = 14;
	final int FLAME_WIDTH = 14;
	
	final int ARROW_XPOS = 77;
	final int ARROW_YPOS = 26;
	final int ARROW_UVX = 176;
	final int ARROW_UVY = 14;
	final int ARROW_HEIGHT = 24;
	final int ARROW_WIDTH = 24;
	...
	public GuiCompressor(InventoryPlayer invPlayer, TileEntityCompressor tileEntityCompressor) {
		...
		this.tileEntity = tileEntityCompressor;
	}
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		double compressRemaining = tileEntity.fractionOfCompressionRemaining();
		int yOffsetArrow = (int)((0.0 - compressRemaining) * ARROW_HEIGHT);
		drawTexturedModalRect(guiLeft + ARROW_XPOS, guiTop + ARROW_YPOS - yOffsetArrow, ARROW_UVX, ARROW_UVY - yOffsetArrow, ARROW_WIDTH, ARROW_HEIGHT + yOffsetArrow);
	}
