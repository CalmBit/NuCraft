...
public class WorldGenPlasmaticTrees extends WorldGenerator
{
	/**
	 * Mininum tree height...
	 */
	private final static int MIN_TREE_HEIGHT = 13;
	private final static int TREE_HEIGHT_DEV = 7;
	private final static Block LEAF_BLOCK = NuCraft.leavesPlasmaticTree;
	private final static Block TRUNK_BLOCK = NuCraft.logPlasmaticTree;
	private final static int LEAF_HEIGHT = 6;
