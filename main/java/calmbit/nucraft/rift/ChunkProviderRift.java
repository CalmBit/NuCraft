...
public class ChunkProviderRift implements IChunkProvider
{
    ...
    private MapGenBase caveGenerator = new MapGenRiftCaves();
    /** Holds ravine generator */
    private MapGenBase ravineGenerator = new MapGenRiftRavine();
    ...
    public ChunkProviderRift(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_147424_3_[j3 += short1] = NuCraft.riftStone;
                                }
                                else if (k2 * 8 + l2 < b0)
                                {
                                    p_147424_3_[j3 += short1] = NuCraft.acidBlock;
                                }
                                else
                                {
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        if (this.rand.nextInt(4) == 0 && TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAKE))
        {
            ...
            (new WorldGenRiftLakes(NuCraft.acidBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
        }
        
        if (this.rand.nextInt(8) == 0 && TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAVA))
        {
            k1 = k + this.rand.nextInt(16) + 8;
            l1 = this.rand.nextInt(256);
            i2 = l + this.rand.nextInt(16) + 8;
            (new WorldGenRiftLakes(NuCraft.riftPlasmaBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
        }
