...
public class BlockRiftBomb extends Block
{
    ...
    public BlockRiftBomb()
    {
        super(Material.tnt);
        this.setStepSound(soundTypeGrass);
        this.setBlockTextureName("nucraftrift:blockRiftBomb");
        this.setBlockName("blockRiftBomb");
    }
    ...
    public void onBlockDestroyedByExplosion(World p_149723_1_, int p_149723_2_, int p_149723_3_, int p_149723_4_, Explosion p_149723_5_)
    {
        ...
        {
            EntityRiftBombPrimed EntityNitroPrimed = new EntityRiftBombPrimed(p_149723_1_, (double)((float)p_149723_2_ + 0.5F), (double)((float)p_149723_3_ + 0.5F), (double)((float)p_149723_4_ + 0.5F), p_149723_5_.getExplosivePlacedBy());
            EntityNitroPrimed.fuse = p_149723_1_.rand.nextInt(EntityNitroPrimed.fuse / 4) + EntityNitroPrimed.fuse / 8;
            p_149723_1_.spawnEntityInWorld(EntityNitroPrimed);
        }
    }
    ...
    public void func_150114_a(World p_150114_1_, int p_150114_2_, int p_150114_3_, int p_150114_4_, int p_150114_5_, EntityLivingBase p_150114_6_)
    {
        if (!p_150114_1_.isRemote)
        {
            if ((p_150114_5_ & 1) == 1)
            {
                EntityRiftBombPrimed EntityNitroPrimed = new EntityRiftBombPrimed(p_150114_1_, (double)((float)p_150114_2_ + 0.5F), (double)((float)p_150114_3_ + 0.5F), (double)((float)p_150114_4_ + 0.5F), p_150114_6_);
                p_150114_1_.spawnEntityInWorld(EntityNitroPrimed);
                p_150114_1_.playSoundAtEntity(EntityNitroPrimed, "game.tnt.primed", 1.0F, 1.0F);
            }
        }
    }
