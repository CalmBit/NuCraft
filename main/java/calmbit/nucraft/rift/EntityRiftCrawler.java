...
public class EntityRiftCrawler extends EntityMob
{
    private static final String __OBFID = "CL_00001699";

    public EntityRiftCrawler(World p_i1743_1_)
    {
        super(p_i1743_1_);
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        {
            this.dropItem(NuCraft.crawlerEye, 1);
        }
    }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_)
    {
        ...
        {
            p_110161_1_1 = new EntityRiftCrawler.GroupData();
            ...
            {
                ((EntityRiftCrawler.GroupData)p_110161_1_1).func_111104_a(this.worldObj.rand);
            }
        }

        if (p_110161_1_1 instanceof EntityRiftCrawler.GroupData)
        {
            int i = ((EntityRiftCrawler.GroupData)p_110161_1_1).field_111105_a;
