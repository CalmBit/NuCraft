...
public class BlockBamboo extends Block implements IPlantable
{
    ...
    private static final int PLANT_HEIGHT = 10;
    private static final int PLANT_RATE = 0;
    ...
    public BlockBamboo()
    {
        ...
        this.setBlockTextureName("nucraftworld:blockBamboo");
    ...
    {
        if (p_149674_1_.getBlock(p_149674_2_, p_149674_3_ - 1, p_149674_4_) == NuCraft.blockBamboo || this.func_150170_e(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_))
        {
    ...
    public boolean canSustainPlant(IBlockAccess world, int x, int y, int z, ForgeDirection direction, IPlantable plantable)
    {
        ...
        if (plant == NuCraft.blockBamboo && ground == NuCraft.blockBamboo)
        {
            return true;
        }
        else
        {
        	 boolean isBeach = ground == Blocks.grass || ground == Blocks.dirt || ground == Blocks.sand;
