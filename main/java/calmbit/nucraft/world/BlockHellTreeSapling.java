...
public class BlockHellTreeSapling extends BlockBush implements IGrowable {

	protected IIcon saplingTexture;
	
	public BlockHellTreeSapling()
	{
		super(Material.grass);
		setStepSound(soundTypeGrass);
		float f = 0.4F;
        this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, f * 2.0F, 0.5F + f);
        setBlockName("saplingHellTree");
        BlockSapling block;
	}
    ...
    {
        return  p_149718_1_.getBlock(p_149718_2_, p_149718_3_ - 1, p_149718_4_) == Blocks.netherrack;
    }
	...
	{
		saplingTexture = register.registerIcon("nucraftworld:saplingHellTree");
	}
	
	public void generate(World world, int x, int y, int z, Random random)
	{
		if(world.getBlock(x, y-1, z) != Blocks.netherrack) return;
		WorldGenHellTrees gen = new WorldGenHellTrees();
