...
public class WorldGenHellTrees extends WorldGenerator
{
	/**
	 * Mininum tree height...
	 */
	public final static int MIN_TREE_HEIGHT = 5;
	public final static int TREE_HEIGHT_DEV = 3;
	private final static Block LEAF_BLOCK = NuCraft.leavesHellTree;
	private final static Block TRUNK_BLOCK = NuCraft.logHellTree;
	private final static int LEAF_HEIGHT = 3;
	...
	{	            
	                    ...
	                    if(y >= 1 && y + treeHeight + 1 <= 256)
	                    {
	                    	...
	                    	else
	                    	{
	                    		...
	                    		//NETHER TREEEEES
	                    		boolean isSoil = block2 == Blocks.netherrack;
	 ...
	 protected boolean isReplaceable(World world, int x, int y, int z)
	 {
	        ...
	        boolean flag1 = block.getMaterial() == Material.air || block.isAssociatedBlock(Blocks.netherrack) || block.isAssociatedBlock(Blocks.soul_sand);
