...
public class WorldGenCherryTrees extends WorldGenerator
{
	...
	private final static int TREE_HEIGHT_DEV = 4;
	private final static Block LEAF_BLOCK = NuCraft.leavesCherry;
	private final static Block TRUNK_BLOCK = NuCraft.logCherry;
	private final static int LEAF_HEIGHT = 3;
	private final static int LEAF_INVERSE_SCALE = 2;
